...
- redis windows客户端(64x)：[https://github.com/MSOpenTech/redis](https://github.com/MSOpenTech/redis) 官网不提供window安装
- java操作redis：[jedis Github](https://github.com/xetorthio/jedis)
